...
main project abspath: %s""" % (name, uri, source_dir, target_dir_rp, source_dir_rp))
                        ...
                        if value == optobject['value']:
                            for name, depobject in optobject['depends'].items():
                                add_module(current_module, name,
                                           ...
                                           depobject)
        Subproject.setLocalIgnores(root, subprojects_dir, modules)
        return root, modules
    ...
    @staticmethod
    def setLocalIgnores(root, subprojects_dir, modules):
        vcs_class(root.directory).setLocalIgnores(root, subprojects_dir, modules)
